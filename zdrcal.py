...
#    nsweeps = int(radar.nsweeps)
    ...
    zdr_bias = create_dict(DR_Avg,DR_Std,NGood,DR_RaySum,DR_RayAvg,DR_RayStd,NGood_Ray,
...
def get_ray_range_dims(ZDR,nrays):
    ...
    return axAz, axHt
#======================================================================
def mask_gates(ZDR,dBZ,Rhv,PhiDP,KDP,Ht,Az,axAz,Htmax=10.,remove_first_n_gates=None):
    # Create 2D arrays for masking data later
...
#======================================================================
def create_dict(DR_Avg,DR_Std,NGood,DR_RaySum,DR_RayAvg,DR_RayStd,NGood_Ray,
                DR_HtAvg,DR_HtStd,NGood_Ht,
                RH_HtAvg,dBZ_HtAvg,KDP_HtAvg,
                ZDR,DR_HtAvg_filt,DR_HtStd_filt,
                RH_HtAvg_filt,dBZ_HtAvg_filt,KDP_HtAvg_filt,PhiDP_HtAvg_filt,
    ...
    zdr_bias = {'volume_average': DR_Avg, 'volume_standard_deviation': DR_Std,
                'volume_number_good': NGood,
                'ray_cumulative_sum': DR_RaySum, 'ray_average': DR_RayAvg,
                'ray_standard_deviation': DR_RayStd, 'ray_number_good': NGood_Ray,
                'height_average': DR_HtAvg,'height_standard_deviation': DR_HtStd, 
                'height_number_good': NGood_Ht, 
                'rhv_height_average': RH_HtAvg, 'dbz_height_average': dBZ_HtAvg,
                'kdp_height_average': KDP_HtAvg,
                'filtered_zdr': ZDR, 'height_average_filt': DR_HtAvg_filt,
                'height_standard_deviation_filt': DR_HtStd_filt,
                'rhv_height_average_filt': RH_HtAvg_filt, 'dbz_height_average_filt': dBZ_HtAvg_filt,
                'kdp_height_average_filt': KDP_HtAvg_filt,'phidp_height_average_filt': PhiDP_HtAvg_filt,
                'radar_name': RadName, 'facility_name': GenName,
                'radar_latitude':Rlat, 'radar_longitude':Rlon, 'radar_altitude':RAlt,
                'time': time, 'range': range, 'azimuth':azimuth}
...
#======================================================================
def plot_3panel(X1,X2,X3,Y,xlims1=None,xlims2=None,xlims3=None,ymax=None,
